...
import { AirbnbIcon, AmazonIcon, DollarSignIcon, FigmaIcon, NetflixIcon, ShoppingCartIcon, SpotifyIcon } from '@/constants/icons'

export default function SpendingBlock({spendingList} : {spendingList: SpendingType[]}) {
    let icon = <DollarSignIcon width={22} height={22} color={Colors.white} /> 
  return (
